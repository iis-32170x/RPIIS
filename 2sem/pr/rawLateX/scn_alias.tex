...
\newcommand{\scntasks}[1]{%
  \scntext{актуальные задачи}{#1}
}
...
\newenvironment{scndecomposition}{%
  \begin{scnrelfromset}{декомпозиция}
}{%
  \end{scnrelfromset}
}

\newenvironment{scnobdecomposition}{%
  \begin{scnrelfromset}{обобщенная декомпозиция}
}{%
  \end{scnrelfromset}
}

\newenvironment{scnatasks}{%
  \begin{scnrelfromset}{актуальные задачи}
}{%
  \end{scnrelfromset}
}

\newenvironment{scnetaps}{%
