...
**Транспонированный граф** - граф, у которого по сравнению с первоначальным тот же набор вершин и дуг, но направления дуг противоположны (т.е. если в графе присутствует дуга *u*->*v*, то в его транспонированном графе будет вместо неё дуга *v*->*u*).
