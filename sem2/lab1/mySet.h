 ...
 * допускается эначение <index> в диапозоне от 0 до size - 1 включая
 ...
 *
 *
 * при сравнени двух множеств сразу сравниваются их мощности, а потом
 * попарно элемепты каждого из множеств
