...
Для представления графа я использовал *список смежности* для более удобной работы. Реализация списка основана на библиотеках map и set на С++.
...
1. **Вставка вершины :** добавление в 
