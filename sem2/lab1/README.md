...
Структура данных
## Цель
Целью данного проекта является разработка библиотеки для работы с AVL-деревом в C++, что позволит исследовать свойства структур данных и оптимизировать процессы поиска, вставки и удаления элементов.
