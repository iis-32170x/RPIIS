...
- g1 получает значения sc-узла первого неориентированного графа (sc-дуга общего вида, а не базового);
- g2 получает значения sc-узла второго неориентированного графа (sc-дуга общего вида, а не базового);
...
- g3 получает в качестве значения скопированный sc-узел первого неориентированного графа (sc-дуга общего вида, а не базового);
...
![image](https://github.com/iis-32170x/RPIIS/assets/144939061/dedecc9f-7197-472c-8140-168b589ad727)
