/**************************************************
Название: Subsets
Разработчик: Самович Вячеслав Максимович
Дата: 21.03.2024
Описание: Реализовать программу, определяющую является ли одно, либо оба из двух исходных
множеств подмножеством или элементом другого. Метод ввода данных: текстовый файл.
...
bool isSubset(Arr* arr1, Arr* arr2) // определяем является ли arr1 подмножеством arr2 (равенство для кортежей)
{
