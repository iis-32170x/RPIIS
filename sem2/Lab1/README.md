...
```
## Тестирование
1. Вывод: Выберите операцию: 1 - добавить строку в бор, 2 - удалить cтроку из бора, 3 - поиск строки в боре, 4 - вывести все строки в боре, 0 - завершить программу
   ...
   Вывод: Строка добавлена
   
   Вывод: Выберите операцию: 1 - добавить строку в бор, 2 - удалить cтроку из бора, 3 - поиск строки в боре, 4 - вывести все строки в боре, 0 - завершить программу
...
2. Вывод: Выберите операцию: 1 - добавить строку в бор, 2 - удалить cтроку из бора, 3 - поиск строки в боре, 4 - вывести все строки в боре, 0 - завершить программу
...
3. Вывод: Выберите операцию: 1 - добавить строку в бор, 2 - удалить cтроку из бора, 3 - поиск строки в боре, 4 - вывести все строки в боре, 0 - завершить программу
