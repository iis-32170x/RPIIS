    ...
    for (i = 0; i < set.size() - 1; i++)
    {
        for (j = i + 1; j < set.size(); j++)
        {
            ...
            if ((set[i][1] == '{') && (set[j][1] == '{'))
            {
                ...
                for (k = 0; k < el1.size() - 1; k++)
                {
                    fnd = false;
                    for (p = 0; p < el2.size(); p++)
                    {
                        if (el1[k] == el2[p])
                        {
                            fnd = true;
...
2. Ввод: { 23, { 4, < 3, 5 > }, < 5, { 5, 6 } >, 7 }
   ...
   Введённое множество: { 23 { 4, < 3, 5 > } < 5, { 5, 6 } > 7 }

Булеан заданного множества:
{ {}, { 23 }, { 23, { 4, < 3, 5 > } }, { 23, { 4, < 3, 5 > }, < 5, { 5, 6 } > }, { 23, { 4, < 3, 5 > }, < 5, { 5, 6 } >, 7 }, { 23, { 4, < 3, 5 > }, 7 }, { 23, < 5, { 5, 6 } > }, { 23, < 5, { 5, 6 } >, 7 }, { 23, 7 }, { { 4, < 3, 5 > } }, { { 4, < 3, 5 > }, < 5, { 5, 6 } > }, { { 4, < 3, 5 > }, < 5, { 5, 6 } >, 7 }, { { 4, < 3, 5 > }, 7 }, { < 5, { 5, 6 } > }, { < 5, { 5, 6 } >, 7 }, { 7 }}
...
7. Ввод: { < 1, 3 >, { 3, { 3, 5 }, 4, { 5, 3 } }, < 5, { 5, 6 } >, 7, 2222 }
