...
Тривиально можно сказать так: основной идентификатор отображает названия узла в системе на русскойм или английском языке, а системный - название, которое можно использовать в коде или где-то еще
...
```
название_элемента_в_коде => nrel_main_idtf:[название_на_английском_или_русском] (*<- системный_идентификатор_языка;; *);;
```
