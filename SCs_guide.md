...
Примечание: Если есть есть точка, то ниженее подчеркивание '_' использовать не нужно
...
Данные записи имеют абсолютно одинаковый смысл, что говорит о независимости направления
