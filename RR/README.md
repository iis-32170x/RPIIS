...
## Описание алгоритма:
1. Добавить ребра графа, принадлежащие контуру графа, во область ребер контура. ()
2. Добавить вершины графа, принадлежащие контуру графа, во область вершин контура.
3. Добавить все рёбра графа во множество непосещенных вершин.
4. Создаем счетчик вершинных связностей.
5. Удалить область ребер контура из множества непосещённых ребёр.
...
10. Вывести полученный результат. Завершить алгоритм.
