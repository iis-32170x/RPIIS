...
4. Все вершины снова записываем в множество `not_visit`.
5. Ищем в глубину все вершины графа, двигаясь по ребрам в обратном направлении, при посещении каждой непосещенной вершины удаляем его из множества `not_visit`.
6. Закончив обход графа в глубину, смотрим сколько элементов в множестве `not_visit`
