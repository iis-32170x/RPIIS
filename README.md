...
переменные:
<br />
-a наше число приходящее от пользователя
-ending цифра на которую заканчивается число
-starting цифра на которую начинается число
-datetemp переменная содержащая дату 
<br />
