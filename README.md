...
- Добавляем их в очередь для дальнейшего обхода.

- Проверяем, были ли соседи уже посещены и являются ли родителями текущей вершины (проверяем наличие цикла в графе).

2. Переходим к вершине 1:

- Проверяем, является ли вершина 0 родителем вершины 1 (да).

- Проверяем вершину на наличие соседей (нет).

3. Переходим к вершине 2:

- Проверяем, является ли вершина 0 родителем вершины 2 (да).

- Проверяем вершину на наличие соседей (нет).

4. Переходим к вершине 3:

- Проверяем, является ли вершина 0 родителем вершины 3 (да).

- Проверяем вершину на наличие соседей (нет).

5. Переходим к вершине 4:

- Проверяем, является ли вершина 0 родителем вершины 4 (да).

- Проверяем вершину на наличие соседей (обнаруживаем вершину 5).
  
- Добавляем её в очередь для дальнейшего обхода.

- Проверяем, была ли вершина 5 уже посещена и является ли родителем текущей вершины (проверяем наличие цикла в графе).
