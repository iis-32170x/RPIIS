(это не конечный результат. Так как я ещё обсуждаю свою формализацию с Данилом Вячеславовичем и не знаю некоторых подробностей (например добавление авторов и тд) + пока по состоянию здоровья что-то круче сделать не могу:()
