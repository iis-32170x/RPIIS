...
- Распространяемся по смежным вершинам: добавляем вершины 1 и 3 в очередь с расстоянием 1.

2. Переходим к вершине 1:

- Распространяемся по смежным вершинам: добавляем вершины 2 и 3 в очередь с расстоянием 2.

- Обнаруживаем, что смежная вершина 3 совпадает с начальной вершиной 0, обновляем минимальное расстояние до цикла = 3.

3. Переходим к вершине 2:

- Распространяемся по смежным вершинам: добавляем вершину 3 в очередь с расстоянием 3.

- Обнаруживаем, что смежная вершина 3 совпадает с начальной вершиной 0, но расстояние 4 больше минимального, поэтому не обновляем минимальное расстояние.
...
## Тестирование
Все тесты производились только через консоль. Скрины правильной работы тестов вы можетет посмотреть [здесь](https://github.com/iis-32170x/RPIIS/tree/%D0%A1%D0%B5%D0%BC%D1%87%D0%B5%D0%BD%D0%BA%D0%BE_%D0%91/%D0%A0%D0%A0/%D1%82%D0%B5%D1%81%D1%82%D1%8B)
